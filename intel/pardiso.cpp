...
//------------------------------------------------------------------------
void FromRSFToCSR_Real_2_Sym(int nb, int* ig, int* jg, MKL_Complex16* di, MKL_Complex16* gg,
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	int* ig = NULL;
	int* jg = NULL;
	MKL_Complex16* di = NULL;
	MKL_Complex16* gg = NULL;
	...
	// di
	di = new MKL_Complex16[nb];
	Read_Bin_File_Of_Complex((path + "di").c_str(), di, nb, 1);

	// gg
	gg = new MKL_Complex16[ig_n_1];
